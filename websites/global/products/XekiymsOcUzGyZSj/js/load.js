...
if (!ltIE9) {
    ...
    document.write('<script src="/websites/global/products/' + producthash + '/js/sonicmaster.js"></script>');
}
...
document.write('<script src="/websites/global/products/' + producthash + '/js/vendor/jquery.colorbox-min.js" type="text/javascript"></script>');
