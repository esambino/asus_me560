...
$(function () {
    ...
    var sectionAry = ['index', 'beauty', 'sound', 'touch', 'response', 'ubiquity', 'app', 'spec', 'accessory'];
    ...
    $("nav.shortcut ul li").bind('click',function(){
    ...
    $("nav.shortcut ul li").bind('mouseover',function(){
        $("nav.shortcut").css('width',300);
    })
    $("nav.shortcut ul li").bind('mouseout',function(){
    ...
    if(ltIE9){
        $('nav.shortcut').css('position','absolute');
        $('nav.shortcut').css('opacity',1);
        $('nav.shortcut').css('top',$(window).scrollTop()-700);
